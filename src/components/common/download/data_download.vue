    ...
    <div  class="download_center">
        ...
        <div class="download">
            ...
            <el-table :data="dataList" border style="width: 100%">
                ...
                <el-table-column prop="documentType" label="文档类型" width="135" align="center">
...
methods: {
    //分页切换事件
     handleCurrentChange(val) {
        this.getDataList(parseInt(val)-1,10);
    },
    //获取资料数据
    getDataList(currentPage,pageCount){
        let params ={
            documentType:2,
    ...
    //下载事件
    downloadDoc(id){
        window.location.href = BaseUrl+"/szipee/downloadDoc?type=2&id="+id
    }
},
components:{
}
